...
/**
 * Servlet implementation class CercaProdottiLib
 */
@WebServlet("/CercaProdottiLi")
public class CercaProdottiLib extends HttpServlet {
	private static final long serialVersionUID = 1L;
    private UtenteBeans utente;   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CercaProdottiLib() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(utente != null) {
						try {
							...
							ArrayList<LezioneBeans>lezioni = new ArrayList<LezioneBeans>();
