...
/**
 * Servlet implementation class RimuoviPreferiti
 */
...
public class RimuoviPreferiti extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(utente != null) {
			String ctrl = request.getParameter("rimuovi");
			
				if(ctrl.equals("si")) {
					
					utente.getAppunti().clear();
					utente.getLezioni().clear();
					utente.getLibri().clear();
					getServletContext().getRequestDispatcher("/preferiti.jsp").forward(request, response);
				}
